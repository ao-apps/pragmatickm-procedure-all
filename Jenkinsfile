...
def upstreamProjects = [
  ...
  'servlet', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-servlet</artifactId>
  'taglib', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-taglib</artifactId>

  // Runtime Direct
  'style', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-style</artifactId>
  'view', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-view</artifactId>
